                    ...
                    <tbody>
                      ...
                      while ($r2 = mysqli_fetch_array($q2)) {
                        ...
                        <tr>
                          ...
                          <td>
                        <a href="kegiatanku.php?op=edit&id=<?php echo $id; ?>"><button type="button" class="badge badge-warning">Edit</button></a>
                        <a href="kegiatanku.php?op=delete&id=<?php echo $id; ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="badge badge-danger">Delete</button></a>
                      </td>
                        </tr>
                        <?php
                      }
