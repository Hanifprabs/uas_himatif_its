...
// Cek tipe pengguna dari session
if ($_SESSION['type'] == "anggota") {
  echo "Hanya untuk pengurus"; // Tampilkan pesan untuk pengguna dengan tipe 'anggota'
...
if ($op == 'delete') {
  $id = $_GET['id'];
  $sql1 = "DELETE FROM kas_masuk WHERE id = '$id'";
...
if ($op == 'edit') {
  $id = $_GET['id'];
  $sql1 = "SELECT * FROM kas_masuk WHERE id ='$id'";
  $q1 = mysqli_query($mysqli, $sql1);
...
if (isset($_POST["simpan"])) { // untuk create
  ...
  if ($nama && $tanggal && $pemasukan && $jumlah && $penerima) {
    if ($op == 'edit') { // untuk update
      $sql1 = "UPDATE kas_masuk SET nama = '$nama', tanggal = '$tanggal', pemasukan = '$pemasukan', jumlah = '$jumlah', penerima = '$penerima', username = '$username' WHERE id = '$id'";
      $q1 = mysqli_query($mysqli, $sql1);
      if ($q1) {
      ...
      $sql1 = "INSERT INTO kas_masuk (nama, tanggal, pemasukan, jumlah, penerima, username) VALUES ('$nama', '$tanggal', '$pemasukan', '$jumlah', '$penerima', '$username')";
      $q1 = mysqli_query($mysqli, $sql1);
      if ($q1) {
        ...
        <div class="card">
          <div class="card-body">
            <?php if ($error) : ?>
              ...
              <?php header("refresh:5;url=manage-kas.php"); // 5 detik 
            endif; ?>
            <?php if ($sukses) : ?>
      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="form-inline mb-3" method="GET" action="manage-kas.php">
                ...
                <tbody>
                  ...
                  while ($r2 = mysqli_fetch_array($q2)) {
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="manage-kas.php?op=edit&id=<?php echo $id; ?>"><button type="button" class="badge badge-warning">Edit</button></a>
                        <a href="manage-kas.php?op=delete&id=<?php echo $id; ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="badge badge-danger">Delete</button></a>
                      </td>
                    </tr>
                    <?php
                  }
