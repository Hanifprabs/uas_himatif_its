                ...
                <div class="card-body">
                  ...
                  <form action="" class="forms-sample" method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="nama_kegiatan" placeholder="Nama Kegiatan"
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputPassword4" name="waktu"
                        placeholder="Waktu" value="<?= htmlspecialchars($waktu ?? ''); ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">Tempat</label>
                      <input type="text" class="form-control" id="exampleInputCity1" name="tempat" placeholder="Tempat"
                        value="<?= htmlspecialchars($tempat ?? ''); ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">Penyelenggara</label>
                      <input type="text" class="form-control" id="exampleInputCity1" name="penyelenggara"
                        placeholder="Penyelenggara" value="<?= htmlspecialchars($penyelenggara ?? ''); ?>">
                    </div>
