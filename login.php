              ...
              <div class="card-body px-5 py-5">
                ...
                <form class="form-horizontal" action="cek.php" method="post">
                  <div class="form-group">
                    <label>NIM</label>
                    <input type="text" class="form-control p_input" name="nim" required>
                  </div>
                  <div class="form-group">
                    <label>Password *</label>
                    <input class="form-control p_input" type="password" name="password" required placeholder="Password">
                  </div>
                  ...
                  <p class="sign-up">Don't have an Account?<a href="register.php" class="text-primary m-l-5"> Sign Up</a></p>
                </form>
              </div>
            </div>
          </div>
